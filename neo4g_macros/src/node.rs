...
pub fn generate_neo4g_node(input: TokenStream) -> TokenStream {
    ...
    let get_node_by_fn = generators::generate_get_node_by(&struct_name, &struct_name_str, &props_enum_name);
    let merge_node_by_fn = generators::generate_merge_node_by(&struct_name, &struct_name_str, &props_enum_name);
